...
public class ModMenuIntegration implements ModMenuApi {
    ...
    public ConfigScreenFactory<?> getModConfigScreenFactory() {
        return parent -> {
            ...
            ConfigBuilder builder = ConfigBuilder.create().setParentScreen(parent).setTitle(new TranslatableText("ModpackLoader Config"));

            ConfigEntryBuilder entryBuilder = builder.entryBuilder();
            final Boolean[] updateOnStart = {true, false};
            ...
            general.addEntry(entryBuilder.startIntField(Text.of("Update interval (in days)"), json.get("updateInterval").getAsInt())
                    .setDefaultValue(1)
                    .setTooltip(new TranslatableText("How often the mod checks for updates"))
            ...
            ConfigCategory local = builder.getOrCreateCategory(new TranslatableText("Local Modpacks"));
            ...
            ConfigCategory host = builder.getOrCreateCategory(new TranslatableText("Hosted Modpacks"));
            ...
            ConfigCategory url = builder.getOrCreateCategory(new TranslatableText("External Modpacks"));
            ...
            for (JsonElement urlModpack : urlPacks) {
                ...
                url.addEntry(entryBuilder.startBooleanToggle(Text.of(FilenameUtils.removeExtension(packName)), state)
            ...
            url.addEntry(entryBuilder.startStrField(Text.of("Custom Modpack (url)"), "")
                    .setDefaultValue("")
                    .setTooltip(new TranslatableText("Click \"Save & Quit\" to save. Invalid URL's will be dismissed"))
