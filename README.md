...
If the mod finds an old version of a mod you have installed, it will replace it automatically with the newest version and rename the old file to `modname.jar.old`. **All mods downloaded by _ModpackLoaderFabric_ come with the suffix `modname_MPLF.jar`**
